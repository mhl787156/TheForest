...
const long cap_values [6] = {0,0,0,0,0,0};
const long capThresholds [6] = {63,63,63,63,63,63}; // NOTE: tune these per pillar once touch sensors are set up
long capCal [6] = {0,0,0,0,0,0};
