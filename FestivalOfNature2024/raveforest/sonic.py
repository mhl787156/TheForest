...
class SoundManager:
    ...
    def __init__(self, pillar_configs):
        ...
        print("Pillar Configs:", pillar_configs.__dict__)
        ...
        params = {tube_param[idx]: pillar_configs.__dict__['Tubes_Param'][idx] for idx in tube_param}
            
            
        # Create Pillar 
        self.pillar = Pillar(**params)
    ...
    def update_pillar_setting(self, setting_name, value):
        ...
        self.pillar_settings = {}
        self.pillar_settings[setting_name] = value
        
        # Update the actual pillar object

        getattr(self.pillar, f'set_{setting_name}')(value)  # Dynamically call the set method



        # Initialize sound parameters for each pillar

        self.pillar.init_sound_thread(self.timing_condition)
    ...
    def set_amp(self, amp):
        self.pillar.set_amp(amp)
    
    def set_pitch(self, pitch):
        self.pillar.set_pitch(pitch)
    
    def set_synth(self, synth):
        self.pillar.set_synth(synth)
    
    def set_bpm(self, bpm):
        self.pillar.set_bpm(bpm)
    
    def set_pan(self, pan):
        self.pillar.set_pan(pan)
    
    def set_envelope(self, envelope):
        self.pillar.set_envelope(envelope)
...
class Pillar:
    ...
    def __init__(self, bpm=120, amp=1.0, pitch=50, synth="saw", pan=0.0, envelope="default"):
        self.bpm = bpm
        self.amp = amp
        self.pitch = pitch
        self.synth = synth
    ...
    def __repr__(self):
        ...
        return f"Pillar {self.parameters}"
