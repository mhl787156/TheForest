"""
SCAMP Extensions Example: SuperCollider made easy
...
# adds various methods like `new_supercollider_part` and `start_recording_sc_output` to the Session object
add_sc_extensions()
...
# records the output of the supercollider parts as a wave file
...
while s.beat() < 20:
    ...
    volume_env = random.choice([
        ...
        Envelope([1, 0.2, 1], [0.1, 1], curve_shapes=[-2, 3])
    ])
